...
*/
	...
	console.log('[Reverse Chars] : Starting with: ', revString);

	console.log('[Reverse Chars] : Reversed: ', reverseString(revString, revChar));
};

reverseStringWrapper();