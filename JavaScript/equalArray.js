...
const equalArrayWrapper = () => {
	

	function checkEqual(arr1, arr2){

		let map1 = new Dictionary();
		let map2 = new Dictionary();
	...
	Dictionary.prototype.addEntry = function(entry){
		if(typeof entry === 'undefined'){
			...
			if(this.map.has(entry)){
				let entryCount = this.map.get(entry);
	...
	*/
	...
	let arr1 = [1, 2, 3, 4, 1, 1, 1, 6];
	let arr2 = [1, 2, 3, 4, 1, 1, 1, 6];

	console.log('[Equal Array] : ', checkEqual(arr1, arr2));
